...
const LayoutChung = () => {
  ...
  return (
    <>
     ...
     {/* ================= MAIN CONTENT (ĐÃ MỞ LẠI) ================= */}
      {/* Outlet là bắt buộc để hiện nội dung trang chủ, tìm kiếm... */}
      <Outlet />
        ...
        <div className="container">
          <div className="footer-grid">
            <div className="footer-col">
              <Link to="/" className="logo"><i className="fa-solid fa-utensils"></i> Bếp Việt</Link>
              <p className="footer-desc">Nơi chia sẻ niềm đam mê nấu nướng và khám phá ẩm thực Việt Nam.</p>
            </div>
            <div className="footer-col">
              <h3>Khám phá</h3>
              <ul>
