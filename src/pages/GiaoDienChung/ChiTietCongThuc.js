...
const ChitietCongthuc = () => {
  ...
  const recipe = {
    ...
    image:
      "https://images.unsplash.com/photo-1582878826618-c05326eff935?q=80&w=2070&auto=format&fit=crop",
    author: "Bếp cô Minh",
    date: "12/05/2024",
    prepTime: "30 phút",
    cookTime: "2 giờ",
    ...
    steps: [
      {
        ...
        content:
          "Xương ống bò rửa sạch, ngâm nước muối loãng 30 phút để ra hết máu tanh. Sau đó, chần xương qua nước sôi khoảng 5 phút rồi vớt ra, rửa lại thật sạch bằng nước lạnh.",
        img: "https://images.unsplash.com/photo-1612874742237-6526221588e3?q=80&w=1000&auto=format&fit=crop",
      },
      {
        id: 2,
        title: "Ninh nước dùng",
        content:
          "Cho xương đã sơ chế vào nồi lớn, đổ ngập 3-4 lít nước. Thêm gừng, hành tím đã nướng thơm và gói gia vị phở vào. Ninh lửa nhỏ trong khoảng 2 giờ.",
        img: "https://images.unsplash.com/photo-1547496502-ffa222335374?q=80&w=1000&auto=format&fit=crop",
      },
      {
        id: 3,
        title: "Hoàn thiện và thưởng thức",
        content:
          "Xếp thịt bò tái lên trên bánh phở. Rắc hành lá, ngò gai lên. Chan nước dùng sôi sùng sục trực tiếp lên thịt để thịt vừa chín tới.",
        img: "https://images.unsplash.com/photo-1582878826618-c05326eff935?q=80&w=2070&auto=format&fit=crop",
      },
    ],
  };
    ...
    <div className="recipe-bottom-layout">
              ...
              <div className="ingredients-box">
                ...
                <ul className="ingredients-list">
                  {recipe.ingredients.map((ing, index) => (
                    <li key={index}>
                      <i className="fa-solid fa-check"></i> {ing}
                    </li>
                  ))}
                </ul>
              </div>
                      ...
                      return (
                        <i
                          ...
                          style={{
                            ...
                            color:
                              ratingValue <= (hoverStar || userRating)
                                ? "#ffc107"
                                : "#e4e5e9",
                            marginRight: "5px",
            ...
            <div className="user-comment-item">
              ...
              <div className="cmt-content">
                ...
                <p className="cmt-text">
                  Công thức rất chuẩn! Nước dùng ngọt thanh, nhà mình ai cũng
                  khen.
                </p>
              </div>
            </div>
      ...
      <aside className="recipe-right-sidebar">
        ...
        <div className="related-list">
          ...
          <article className="related-item">
            <img
              src="https://images.unsplash.com/photo-1628198640748-417c128063f8?q=80&w=1000&auto=format&fit=crop"
              alt="Related"
            />
            <div>
